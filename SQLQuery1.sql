...
public class Register
{
    ...
    [RegularExpression(@"^[a-zA-Z0-9\s,.\-#/]+$", ErrorMessage = "Billing address must not contain special characters")]
    ...
    [RegularExpression(@"^\d+$", ErrorMessage = "Credit card must contain numbers only")]
